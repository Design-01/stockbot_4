...
class TwelveData:
    ...
    def __init__(self, api_key):
        ...
        self.data_folder = os.path.join('data', 'historical_data')
        os.makedirs(self.data_folder, exist_ok=True)

    def get_historical_data(self, symbol, interval='1day', start_date=None, end_date=None, outputsize=None, save_format='csv'):
        """
    ...
    def get_last_n_days(self, symbol, n_days, interval='1day', save_format='csv'):
        """
        ...
        return self.get_historical_data(symbol, interval, start_date, end_date, save_format=save_format)

    def save_data(self, df, symbol, interval, save_format):
        """
...
# data = td.get_historical_data("AAPL", start_date="2023-01-01", end_date="2023-05-01", save_format='csv')
# print(data)

# last_30_days = td.get_last_n_days("AAPL", 30, save_format='excel')
# print(last_30_days)
